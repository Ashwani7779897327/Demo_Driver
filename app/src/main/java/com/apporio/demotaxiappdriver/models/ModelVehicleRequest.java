...
public class ModelVehicleRequest {
    ...
    public static class DataBean {
        ...
        private OwnerDriverBean owner_driver;
        ...
        public OwnerDriverBean getOwner_driver() {
            return owner_driver;
        }

        public void setOwner_driver(OwnerDriverBean owner_driver) {
            this.owner_driver = owner_driver;
        }
