...
public class OutStationUpcomingFragment extends BaseFragment implements ApiManager.APIFETCHER {

    @Bind(R.id.no_record_found)
    TextView no_record_outstation;
    ...
    public OutStationUpcomingFragment() {
    }

    public static OutStationUpcomingFragment newInstance() {
        OutStationUpcomingFragment fragment = new OutStationUpcomingFragment();
        return fragment;
    }
    ...
    public void onFetchComplete(Object script, String APINAME) {
        try {
            no_record_outstation.setVisibility(View.GONE);
    ...
    public void onFetchResultZero(String script, String APINAME) {
        try {
            ...
            no_record_outstation.setText(script);
            no_record_outstation.setVisibility(View.VISIBLE);
        }catch (Exception e){
        }
    }
    ...
    class HolderNewRequest {
        ...
        private void setDataAccordingly() throws Exception {
            ...
            estimation.setText(""+mData.getEstimate_bill());
