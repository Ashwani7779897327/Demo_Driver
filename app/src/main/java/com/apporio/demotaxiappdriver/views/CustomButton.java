...
public class CustomButton extends RelativeLayout {
    ...
    @Nullable
    private ProSwipeButton.OnSwipeListener swipeListener = null;
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                in.shadowfax.proswipebutton.R.styleable.ProSwipeButton,
                0, 0);
        try {
            final String btnString = a.getString(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_btn_text);
            if (btnString != null)
                btnText = btnString;
            textColorInt = a.getColor(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_text_color, ContextCompat.getColor(context, android.R.color.white));
            bgColorInt = a.getColor(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_bg_color, ContextCompat.getColor(context, in.shadowfax.proswipebutton.R.color.proswipebtn_red));
            arrowColorInt = a.getColor(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_arrow_color, ContextCompat.getColor(context, in.shadowfax.proswipebutton.R.color.proswipebtn_translucent_white));
            btnRadius = a.getFloat(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_btn_radius, BTN_INIT_RADIUS);
            textSize = a.getDimensionPixelSize(in.shadowfax.proswipebutton.R.styleable.ProSwipeButton_text_size, (int) DEFAULT_TEXT_SIZE);
        } finally {
            a.recycle();
        }
    }
    ...
    public void init() {
        ...
        view = inflater.inflate(in.shadowfax.proswipebutton.R.layout.view_proswipebtn, this, true);
    }
    ...
    protected void onFinishInflate() {
        ...
        contentContainer = view.findViewById(in.shadowfax.proswipebutton.R.id.relativeLayout_swipeBtn_contentContainer);
        arrowHintContainer = view.findViewById(in.shadowfax.proswipebutton.R.id.linearLayout_swipeBtn_hintContainer);
        contentTv = view.findViewById(in.shadowfax.proswipebutton.R.id.tv_btnText);
        arrow1 = view.findViewById(in.shadowfax.proswipebutton.R.id.iv_arrow1);
        arrow2 = view.findViewById(in.shadowfax.proswipebutton.R.id.iv_arrow2);
    ...
    public void showResultIcon(boolean isSuccess) {
        ...
        Drawable icon;
        if (isSuccess)
            icon = ContextCompat.getDrawable(context, in.shadowfax.proswipebutton.R.drawable.ic_check_circle_36dp);
        else
            icon = ContextCompat.getDrawable(context, in.shadowfax.proswipebutton.R.drawable.ic_cancel_full_24dp);
    ...
    public void setOnSwipeListener(@Nullable ProSwipeButton.OnSwipeListener customSwipeListener) {
