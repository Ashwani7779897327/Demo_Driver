...
/*    String BASE = "http://apporioinfolabs.com/ApporiotaxiOnesignal/";
    ...
    String BASE = "http://apporiotaxi.com/portuguese/";
    String baseDomain = BASE + "api/";
    String imageDomain = BASE + "";
    String restdomain = BASE + "Apporiotaxi/";
    ...
    String CustomerSupport = baseDomain + "driver/customer_support";  //  application(1 for user and 2 for demotaxiappdriver)  name  email  phone  query  driver_id  user_id
